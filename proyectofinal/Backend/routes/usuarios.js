...
router.get('/', function (req, res, next) {
    try {
        var queryString = `SELECT id,userName,altura,peso,sexo,edad,foto, email,deviceId, (peso/1000 / (altura * altura))*10000 as imc FROM usuarios`;
...
router.get('/gimnasio/:idGimnasio', function (req, res, next) {
    try {
        ...
        var queryString = `SELECT id,userName,altura,peso,sexo,edad,foto,email,deviceId, (peso/1000 / (altura * altura))*10000 as imc FROM usuarios WHERE idGimnasio = ${idGimnasio}`;
...
router.get('/email/:email/password/:password', function (req, res, next) {
    try {
        ...
        var queryString = `SELECT id,userName,altura,peso,sexo,edad,foto,email,deviceId, (peso/1000 / (altura * altura))*10000 as imc FROM usuarios where email = '${email}' AND password = '${password}'`;
...
router.get('/:id', function (req, res, next) {
    try {
        ...
        var queryString = `SELECT id,userName,altura,peso,sexo,edad, foto ,email,deviceId, (peso/1000 / (altura * altura))*10000 as imc FROM usuarios where Id = '${id}'`;
